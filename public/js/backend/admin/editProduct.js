...
function createNameList(data) {
  ...
  var form = document.querySelector('#productNameListRepeat');
}
function createBrandList(data) {
  var dataArrayBrand = JSON.parse(data['productBrandList']);
  var form = document.querySelector('#productBrandListRepeat');
  dataArrayBrand.forEach(function (record, index) {
    ...
    codeInput.name = "productBrand-Code[".concat(index, "]");
    ...
    brandInput.name = "productBrand-Brand[".concat(index, "]");
    ...
    fzcodeInput.name = "productBrand-FZCode[".concat(index, "]");
...
/******/ 	__webpack_require__.O(undefined, ["css/frontend/product","css/frontend/includes/productList","css/frontend/contact","css/backend/admin/newProduct","css/backend/admin/editProduct","css/ui/sidebar","css/ui/footer","css/includes/filter","css/frontend/type","css/frontend/product/productDetail"], () => (__webpack_require__("./resources/js/backend/admin/editProduct.js")))
/******/ 	__webpack_require__.O(undefined, ["css/frontend/product","css/frontend/includes/productList","css/frontend/contact","css/backend/admin/newProduct","css/backend/admin/editProduct","css/ui/sidebar","css/ui/footer","css/includes/filter","css/frontend/type","css/frontend/product/productDetail"], () => (__webpack_require__("./resources/scss/backend/admin/editProduct.scss")))
...
/******/ 	__webpack_require__.O(undefined, ["css/frontend/product","css/frontend/includes/productList","css/frontend/contact","css/backend/admin/newProduct","css/backend/admin/editProduct","css/ui/sidebar","css/ui/footer","css/includes/filter","css/frontend/type","css/frontend/product/productDetail"], () => (__webpack_require__("./resources/scss/ui/footer.scss")))
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["css/frontend/product","css/frontend/includes/productList","css/frontend/contact","css/backend/admin/newProduct","css/backend/admin/editProduct","css/ui/sidebar","css/ui/footer","css/includes/filter","css/frontend/type","css/frontend/product/productDetail"], () => (__webpack_require__("./resources/scss/ui/sidebar.scss")))
