<div class="searchbar" style="width: 100vw; height: 5rem; background-color: #adadad; position: sticky; top: 0;">
    <form action="{{ isset($productType) ? route('frontend.product.search', ['productType' => $productType]) : route('product.search') }}" method="post" class="form" style="display: flex; flex-direction: row; justify-content: end; align-items: center; height: 100%; padding: 0 5rem;width: 100vw;">
        @csrf
